...
public class AuthController{
    ...
    public ResponseEntity<AuthResponse> registerClient(@RequestBody
                                                       @Valid
    ...
    public ResponseEntity<AuthResponse> registerAdmin(@RequestBody
                                                      @Valid
    ...
    public ResponseEntity<AuthResponse> registerCoordinator(@RequestBody
                                                            @Valid
