...
package edu.unimagdalena.uStore.security.config;

import edu.unimagdalena.uStore.security.error.Http401EntryPoint;
import edu.unimagdalena.uStore.security.error.Http403AccessDenied;
...
public class SecurityConfig{
    ...
    public SecurityConfig(JwtAuthenticationFilter jwtFilter, Http401EntryPoint authEntryPoint,
                          Http403AccessDenied accessDenied){
